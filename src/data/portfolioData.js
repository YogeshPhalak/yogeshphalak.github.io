...
export const journey = [{
    ...
    location: "Blacksburg, VA",
    category: "Milestone",
    url: "https://hdl.handle.net/10919/135390"
}, {
    id: 3,
    date: "August 2022",
...
export const projects = [{
    date: '2025-10-31',
    category: ['repository', 'simulation'],
    ...
    date: '2025-05-19',
    category: ['publication/Presentation', 'research'],
    title: 'Hyper-Yoshimura: Unleashing Meta-Stability in Deployable Robots',
    venue: 'Submitted to Science Advances (Preprint Available)/ Presented at ICRA 2025, Atlanta, GA, ',
    link: 'https://drive.google.com/file/d/1clhOLkgIIjW5CvjkqZaGaYqOwL4HLS5X/view?usp=sharing',
    tags: ['Origami', 'Robotics', 'Deployable Structures', 'Nonlinear Dynamics'],
    image: '/images/projects/image55.gif?w=600',
    audience: 'Faculty & Graduate Students',
}, {
    date: '2025-05-29',
    category: ['repository', 'nonlinear-dynamics', 'research'],
    ...
    image: '/images/projects/image54.png?w=600',
    stars: 1,
}, {
    date: '2024-12-01',
    category: ['publication/Presentation', 'research', 'biomechanics', 'simulation'],
    title: 'Optimal Snake Locomotion on Flat Surfaces: An Analytical Framework',
    venue: 'Accepted to Philosophical Transactions A',
    link: 'https://drive.google.com/file/d/1k0QxeW6AdNvIre8mLTj01F6oU64dwaTz/view?usp=sharing',
    tags: ['Biomechanics', 'Robotics', 'Snake Locomotion', 'Analytical Mechanics'],
    image: '/images/projects/image75.png?w=600',
    impact: 'High',
}, {
    date: '2024-08-27',
    category: ['publication/Presentation', 'robotics', 'simulation'],
    title: 'Golden Ratio Yoshimura for Meta-Stable Deployment',
    venue: 'Philosophical Transactions A / Presented at IDETC-CIE 2024',
    link: 'https://drive.google.com/file/d/1mCvEoJN8KcLB9GUSsS7apbiOYhx_tDeg/view?usp=sharing',
    tags: ['Origami', 'Deployable Structures', 'Mechanical Design'],
    image: '/images/projects/image5.png?w=600',
    impact: 'High',
}, {
    date: '2023-12-06',
    category: ['publication/Presentation', 'research', 'biomechanics', 'robotics'],
    ...
    image: '/images/projects/image126.gif?w=600',
    audience: '100+ Researchers',
}, {
    date: '2025-07-31',
    category: ['research', 'simulation', 'nonlinear-dynamics'],
    ...
    link: 'https://drive.google.com/file/d/1ufeD48C-giHgo9nE8si9TBD-0oA8dcGC/view?usp=sharing',
    tags: ['Origami', 'Reservoir Computing', 'Nonlinear Dynamics', '3D Visualization'],
    image: '/images/projects/image22.gif?w=600',
}, {
    date: '2023-05-29',
    category: ['repository', 'simulation', 'biomechanics'],
    ...
    image: 'https://github.com/YogeshPhalak/tetra-edm-localizer/blob/main/media/Tetrahedron_sensor_arrengement_mounted_on_mobile_robot%20-%20Copy.jpg?raw=true?w=600',
    stars: 5,
}, {
    date: '2022-12-07',
    category: ['repository', 'simulation'],
    ...
    date: '2020-08-28',
    category: ['repository', 'research', 'biomechanics', 'simulation'],
    ...
    image: 'https://github.com/YogeshPhalak/Simulation-Of-Cable-Driven-Flexible-Manipulators-Using-Matlab-and-Simulink/blob/master/media/Simulink.PNG?raw=true?w=600',
    stars: 15,
}, {
    date: '2020-08-01',
    category: ['publication/Presentation', 'robotics', 'research'],
    ...
    image: '/images/projects/image31.png?w=600',
    impact: 'Milestone',
}, {
    date: '2019-03-01',
    category: ['research'],
    ...
    image: '/images/projects/image44.png?w=600',
}, {
    date: '2018-12-01',
    category: ['publication/Presentation', 'robotics'],
    title: 'OSWalT: Omnidirectional Spherical Wall Traversing Robot',
    description: 'Designed and prototyped a wall-climbing robot using propeller thrust for adhesion, independent of surface inclination / Presented at ICRA 2018, Brisbane, Australia.',
    link: 'https://link.springer.com/chapter/10.1007/978-981-15-3639-7_3',
    tags: ['Hardware', 'Robotics', 'Mechanical Design', 'UAV'],
    image: '/images/projects/image10.png?w=600',
    impact: 'High',
},];
